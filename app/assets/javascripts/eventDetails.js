...
const userEmailsElement = document.querySelector('.entity-details-data-field-with-multiple-values-wrapper');
...
const putDataInForm = (response) => {
  ...
  response.invited_users.data.forEach((invitedUser) => {
    ...
    emailText.innerText = invitedUser.attributes.user.data.attributes.email;
